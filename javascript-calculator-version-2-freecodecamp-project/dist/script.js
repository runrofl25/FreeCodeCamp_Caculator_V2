...
class App extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
    ...
    e => {
      ...
      switch (innerText) {
        ...
        default:{
            let e = undefined;
            //check for other op sir
            if (ops.include(innerText)) {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("div", { id: "display", className: "display" }, " ", calc), /*#__PURE__*/


      React.createElement("div", { className: "nums-container" }, /*#__PURE__*/
      React.createElement("button", { className: "big-h light-grey ac", onClick: this.handleClick, id: "clear" }, "AC"),

      nums.map((num) => /*#__PURE__*/
      React.createElement("button", { className: `dark-grey ${num === 0 && 'big-h'}`, key: num, onClick: this.handleClick,
        id: ids[num] },
      num)), /*#__PURE__*/


      React.createElement("button", { className: "light-grey", onClick: this.handleClick, id: "decimal" }, ".")), /*#__PURE__*/
